...
public interface Constants {
    ...
    public static final String PREF_MENUBACK_FIRST_ERR_WAIT = "pref_menuback_first_ebluros_wait";
    public static final String PREF_MENUBACK_LAST_ERR_WAIT = "pref_menuback_last_ebluros_wait";
    ...
    public static final String PFK_MENUBACK_FIRST_ERR_WAIT = "/sys/class/misc/phantom_kp_filter/menuback_first_ebluros_wait";
    public static final String PFK_MENUBACK_LAST_ERR_WAIT = "/sys/class/misc/phantom_kp_filter/menuback_last_ebluros_wait";
